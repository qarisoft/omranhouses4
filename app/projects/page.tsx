...
export default function BlogPage() {
  ...
  const data2: PageItem[] = [
    {
      className: "", index: 0, imgUrl: 'alnakheel/out/1.jpg', mobileImgUrl: 'alnakheel/out/1.jpg', title: 'مشروع منازل 102', address: 'حي النخيل', images: ['DSC02840-HDR.jpg',
    ...
    { className: "", index: 1, imgUrl: 'morowa/out/1.jpg', mobileImgUrl: 'morowa/out/1.m.jpg', title: 'مشروع منازل المروة', address: 'حي المروة', images: morowaPhotos },
    { className: "", index: 2, imgUrl: 'morowa/out/2.jpg', mobileImgUrl: 'morowa/out/2.m.jpg', title: 'مشروع منازل المروة', address: 'حي المروة', images: morowaPhotos },
    { className: "", index: 3, imgUrl: 'morowa/out/3.jpg', mobileImgUrl: 'morowa/out/3.m.jpg', title: 'مشروع منازل المروة', address: 'حي المروة', images: morowaPhotos },
      ...
      <CardBody className="overflow-visible py-2">
        ...
        <Drawer isOpen={isOpen} onOpenChange={onOpenChange}>
          <DrawerContent>
            {(onClose) => (
              <>
                <DrawerHeader className="flex flex-col gap-1">{item.title}</DrawerHeader>
                <DrawerBody>
